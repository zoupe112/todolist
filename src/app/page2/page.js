...
function App() {
    ...
    return (
        <div className="bg-gradient-to-r from-cyan-500 to-blue-500 flex justify-center" style={{ fontSize: '20px', fontFamily: 'inherit', height: '100vh' }}>
            <div>
                <br></br><br></br><br></br><br></br><br></br><br></br><br></br><br></br><br></br>
                <h1 style={{ textAlign: 'center', fontSize: '36px', fontWeight: 'bold', color: 'white' }}>TodoList</h1><br></br>
                    ...
                    <ul>
                        {list.map((obj, index) => (
                            <li key={obj.id} style={{ backgroundColor: 'white', borderRadius: '10px', padding: '10px 10px', margin: '10px', }}>
                                {updateindex === index ?
                                    <div className="flex justify-between pl-7" style={{ alignItems: 'center' }}>
                                        <input
                                            type="text"
                                            value={updateinput}
                                            onChange={(e) => setUpdateinput(e.target.value)}
                                            style={{ outline: 'none', display: 'flex', alignItems: 'center', borderBottom: '2px solid #E8E6E6', width: '81%' }} />
                                    ...
                                    : <div className="flex justify-between pl-7" style={{ alignItems: 'center' }}>
                                        <div style={{ borderBottom: '2px solid #E8E6E6', width: '81%' }}>{obj.todo}</div>
                                        <div>
